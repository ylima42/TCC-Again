        ...
        <div class="order-md-last">
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <h6 class="my-0">Duzia de Pastel de carne</h6>
                <small class="text-body-secondary">Saboroso e crocante</small>
              </div>
              <span class="text-body-secondary">3.500 Kz</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <h6 class="my-0">Bolo de chocolate</h6>
                <small class="text-body-secondary">Fatia generosa</small>
              </div>
              <span class="text-body-secondary">1.200 Kz</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <h6 class="my-0">Mini pizza</h6>
                <small class="text-body-secondary">Recheio de frango</small>
              </div>
              <span class="text-body-secondary">1.200 Kz</span>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span>Total (KZ)</span>
              <strong>Kz 5.900</strong>
            </li>
          </ul>
            ...
            <div class="search-bar row bg-light p-2 rounded-4">
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="index.html" method="post">
                  <input type="text" class="form-control border-0 bg-transparent" placeholder="Procure por produto">
                </form>
              </div>
              <div class="col-1">
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle pe-3" role="button" id="pages" data-bs-toggle="dropdown" aria-expanded="false">Paginas</a>
                <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                  <li><a href="index.html" class="dropdown-item">Sobre </a></li>
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">Doces</span> e Salgados na sua <span class="fw-bold">Casa</span></h2>
            <p class="fs-4">Os sabores da nossa pastelaria direto para o seu conforto.</p>
            <div class="d-flex gap-3">
              <a href="#" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Ver Cardápio</a>
              <a href="#" class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Fazer Pedido</a>
            </div>
            <div class="row my-5">
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">20+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Tipos de Produtos</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">50+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Clientes Satisfeitos</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">1</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Loja Online</p></div>
                </div>
              </div>
            </div>
            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card-body p-0">
                        <h5 class="text-light">Recheio Sempre Fresco</h5>
                        <p class="card-text">Ingredientes selecionados e preparados com carinho.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="card border-0 bg-secondary rounded-0 p-4 text-light">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card-body p-0">
                        <h5 class="text-light">Feito com Amor</h5>
                        <p class="card-text">Nossa massa e recheios são preparados artesanalmente.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="card border-0 bg-danger rounded-0 p-4 text-light">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card-body p-0">
                        <h5 class="text-light">Entrega Rápida</h5>
                        <p class="card-text">Receba sua encomenda com rapidez e segurança.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-4">
              ...
              <h2 class="section-title">ESCOLHA</h2>

              <div class="d-flex align-items-center">
                <a href="#" class="btn btn-primary rounded-1">Ver tudo</a>
              </div>
            </div>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
                ...
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="img/argola.jpg" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Argolas</h3>
                    <div>
                      <span class="rating">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>KZ 3.500</del>
                      <span class="text-dark fw-semibold">KZ 3.000</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">14,29% OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="img/galete.jpg" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Galete</h3>
                    <div>
                      <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>KZ 2.500</del>
                      <span class="text-dark fw-semibold">KZ 2.000</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">14,29% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="img/pizza.jpg" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Mini Pizza</h3>
                    <div>
                      <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
